...
public class T02PersonalDetailActivity extends B01BaseActivity {
	...
	private TextView view_agency,view_region,edit_region,edit_agency ;
	...
	private void doFinish() {
		// TODO Auto-generated method stub
		new MemberServer(this).accountProfileEdit(FyfUtils.sexToId(edit_sex.getText().toString()), edit_age.getTag().toString(), edit_agency.getTag().toString(), edit_addr.getText().toString(), edit_name.getText().toString(),new CallBack<UserInfo>() {
