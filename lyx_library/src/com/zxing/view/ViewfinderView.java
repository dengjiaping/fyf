...
public final class ViewfinderView extends View {
	...
	private volatile int laserPosition ;
	
	private volatile Rect frame = null ;
	...
	protected void onAttachedToWindow() {
		...
		executor.scheduleWithFixedDelay(new Runnable() {
			...
			public void run() {
				...
				laserPosition += (int) (frame.height() * 0.008)  ;
...
//			paint.setAlpha(SCANNER_ALPHA[scannerAlpha]);
			...
			Log.d("ViewfinderView", "laserPosition = " + laserPosition) ;
			canvas.drawRect(frame.left + 2,frame.top + laserPosition, frame.right - 1,
					frame.top + laserPosition + 3, paint);
